        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-gray-300 hover:text-pastel-rose-soft transition-colors duration-300">
                  Inicio
                </Link>
              </li>
              <li>
                <Link to="/servicios" className="text-gray-300 hover:text-pastel-rose-soft transition-colors duration-300">
                  Servicios
                </Link>
              </li>
              <li>
                <Link to="/reservar" className="text-gray-300 hover:text-pastel-rose-soft transition-colors duration-300">
                  Reservar Cita
                </Link>
              </li>
              <li>
                <Link to="/contacto" className="text-gray-300 hover:text-pastel-rose-soft transition-colors duration-300">
                  Contacto
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center space-x-2">
                <FiMapPin className="text-pastel-cyan" size={16} />
                <span className="text-gray-300 text-sm">Granada, España</span>
              </li>
              <li className="flex items-center space-x-2">
                <FiPhone className="text-pastel-rose-soft" size={16} />
                <span className="text-gray-300 text-sm">+34 XXX XXX XXX</span>
              </li>
              <li className="flex items-center space-x-2">
                <FiMail className="text-pastel-beige" size={16} />
