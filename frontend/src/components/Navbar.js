          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1">
              {navItems.map((item) => (
                <Link
                  ...
                  className={`block px-3 py-2 rounded-md font-medium transition-colors duration-300 ${
                    isActive(item.path)
                      ? 'text-primary-600 bg-pastel-pink'
                      : 'text-gray-700 hover:text-primary-600 hover:bg-pastel-pink'
                  }`}
                >
                  {item.name}
                </Link>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center space-x-2 px-3 py-2 rounded-md font-medium text-gray-700 hover:text-primary-600 hover:bg-pastel-pink transition-colors duration-300"
              >
                <FiInstagram size={20} />
                <span>Instagram</span>
              </a>
